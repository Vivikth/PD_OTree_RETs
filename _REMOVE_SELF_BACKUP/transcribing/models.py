...
class Player(BasePlayer):
    ...
    def getting_text(self, Call_Loc = "Task"):
        ...
        if self.in_round(1).level == 1:
            ...
            self.in_round(self.round_number + 1 - dummy_sub).image_path = 'task_transcribing1a/Digits/{}.gif'.format(self.in_round(self.round_number + 1 - dummy_sub).correct_text)
            ...
            self.in_round(self.round_number + 1 - dummy_sub).image_path = 'task_transcribing1a/Capital_Letters/{}.gif'.format(self.in_round(self.round_number + 1 - dummy_sub).correct_text)
            ...
            self.in_round(self.round_number + 1 - dummy_sub).image_path = 'task_transcribing1a/Greek/{}.gif'.format(Constants.greek_to_name(self.in_round(self.round_number + 1 - dummy_sub).correct_text))
            ...
            self.in_round(self.round_number + 1 - dummy_sub).image_path = 'task_transcribing1a/Punctuation/{}.gif'.format(Constants.punctuation_to_name(self.in_round(self.round_number + 1 - dummy_sub).correct_text))
